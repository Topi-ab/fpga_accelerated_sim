...
proc create_root_design { parentCell } {
  ...
  set acc_axil [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 acc_axil ]
  set_property -dict [ list \
   CONFIG.ADDR_WIDTH {32} \
   CONFIG.DATA_WIDTH {64} \
   CONFIG.NUM_READ_OUTSTANDING {25} \
   CONFIG.NUM_WRITE_OUTSTANDING {25} \
   CONFIG.PROTOCOL {AXI4LITE} \
   ] $acc_axil


  # Create ports
  set clk_250m [ create_bd_port -dir O -type clk clk_250m ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {acc_axil} \
 ] $clk_250m
  set clk_250m_resetn [ create_bd_port -dir O -from 0 -to 0 -type rst clk_250m_resetn ]
...
\
  ...
  # Create instance: axi_passthrough_stub_0, and set properties
  set block_name axi_passthrough_stub_v1_0
  set block_cell_name axi_passthrough_stub_0
  if { [catch {set axi_passthrough_stub_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_passthrough_stub_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_data_fifo_0_M_AXI [get_bd_intf_pins axi_data_fifo_0/M_AXI] [get_bd_intf_pins axi_crossbar_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_data_fifo_1_M_AXI [get_bd_intf_pins axi_data_fifo_1/M_AXI] [get_bd_intf_pins axi_dwidth_converter_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_passthrough_stub_0_EXT [get_bd_intf_ports acc_axil] [get_bd_intf_pins axi_passthrough_stub_0/EXT]
  connect_bd_intf_net -intf_net axi_protocol_convert_0_M_AXI [get_bd_intf_pins axi_passthrough_stub_0/S_AXI] [get_bd_intf_pins axi_protocol_convert_0/M_AXI]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_passthrough_stub_0/S_AXI/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_passthrough_stub_0/EXT] [get_bd_addr_segs acc_axil/Reg] -force
